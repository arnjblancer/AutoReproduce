...
The teacher model resnet32x4 checkpoint is under 'zxl/dkd/source/resnet32x4_vanilla/ckpt_epoch_240.pth'
Training dataset are under the folder 'zxl/dkd/source'.
...
# METRIC='MSE'
# INSTRUCTION =f"""You are assigned an arXiv paper {TITLE} to replicate. You need to replicate the experiment conducted for {TASK} dataset in the paper.
# Training and testing dataset are under the folder 'zxl/simvp/source/train-images-idx3-ubyte.gz' and 'zxl/simvp/source/mnist_test_seq.npy' .
...
# METRIC='MSE'
# INSTRUCTION =f"""You are assigned an arXiv paper {TITLE} to replicate. You need to replicate the experiment conducted for {TASK} dataset in the paper.
# Training and testing dataset are under the folder 'zxl/lsm/source/piececonst_r421_N1024_smooth1.mat' and 'zxl/lsm/source/piececonst_r421_N1024_smooth12.mat' .
...
# Data is under path 'zxl/itransformer/traffic.csv'.
...
# INSTRUCTION =f"""You are assigned an arXiv paper {TITLE} to replicate. You need to replicate the experiment conducted for {TASK} dataset in the paper.
# The experimental settings for the pretrained backbone network is Swin-Tiny under the path 'zxl/iebins/source/swin_tiny_patch4_window7_224_22k.pth'. You should load pretrained model for experiment.
# Training and testing dataset are under the folder 'zxl/iebins/source/train/' and 'zxl/iebins/source/test/' with corresponding index file 'zxl/iebins/source/nyudepthv2_train_files_with_gt_dense.txt' and 'zxl/iebins/source/nyudepthv2_test_files_with_gt.txt'.
...
# INSTRUCTION =f"""You are assigned an arXiv paper {TITLE} to replicate. You need to replicate the experiment conducted for {TASK} dataset in the paper.
# Training dataset are under the folder 'zxl/timevae/source/sine_subsampled_train_perc_20.npz'.
...
# METRIC='accuracy'
# INSTRUCTION =f"""You are assigned an arXiv paper {TITLE} to replicate. You need to replicate the experiment conducted for {TASK} dataset in the paper.
# Training and testing dataset are under the folder 'zxl/tdgnn/source/Citeseer'.
...
# METRIC='mean dice'
# INSTRUCTION =f"""You are assigned an arXiv paper {TITLE} to replicate. You need to replicate the experiment conducted for {TASK} dataset in the paper.
# Training and testing dataset are under the folder 'zxl/swinunet/source/Synapse'. 
...
# METRIC='psnr'
# INSTRUCTION =f"""You are assigned an arXiv paper {TITLE} to replicate. You need to replicate the experiment conducted for {TASK} dataset in the paper.
# Training and testing dataset are under the folder 'zxl/sfnet/source/reside-indoor'. 
...
# METRIC='ADE'
# INSTRUCTION =f"""You are assigned an arXiv paper {TITLE} to replicate. You need to replicate the experiment conducted for {TASK} dataset in the paper.
# Training and testing dataset are under the folder 'zxl/humanmac/source'. 
...
# METRIC='ssim'
# INSTRUCTION =f"""You are assigned an arXiv paper {TITLE} to replicate. You need to replicate the experiment conducted for {TASK} dataset in the paper.
# Training and testing dataset are under the folder 'zxl/WBDM/source'. 
...
# METRIC='PSNR'
# INSTRUCTION =f"""You are assigned an arXiv paper {TITLE} to replicate. You need to replicate the experiment conducted for {TASK} dataset in the paper.
# Training and testing dataset are under the folder 'zxl/DAT/source'. 
